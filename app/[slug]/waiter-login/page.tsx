...
export default function WaiterLoginPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/${slug}/waiter/login`, {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Waiter Login</h1>
          <p className="text-sm sm:text-base text-gray-600">Enter your 4-digit PIN to continue</p>
        </div>
